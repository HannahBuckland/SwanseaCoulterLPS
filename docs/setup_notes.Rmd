...
This function produces plots and outputs the processed data for any file that has been processed using the HBuckland preferences using the Beckman software. The plots produced by the function for each sample analysed:
